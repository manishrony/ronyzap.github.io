...
# Optional: meter the fans' own electricity use via a Tapo smart plug —
# see README.md's \"Metering the fans' own electricity use\" section.
# CLOUDLINE_TAPO_HOST=
# CLOUDLINE_TAPO_EMAIL=
# CLOUDLINE_TAPO_PASSWORD=
# CLOUDLINE_TAPO_RATE=0.25
EOF"
